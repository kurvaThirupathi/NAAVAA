            ...
            <section>
                <div className="relative h-[150px] md:h-[200px] bg-cover bg-center flex items-center justify-center"
                    ...
                    <div className=" relative z-10 px-7 py-4 text-center" >
                        <h1 className="text-white text-2xl md:text-3xl font-semibold lg:mt-5">Stories</h1>
                    </div>
                </div>
                    ...
                    <div className="bg-[#f5f5f5] pt-10 relative bg-repeat bg-center bg-[url('https://themesflat.co/html/wizym/image/footer.jpg')]">
                        <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
                            ...
                            <div className="relative w-full h-[150px] flex-shrink-0 group-hover/view:scale-[1.04] [transition:all_0.5s_ease]">
                                ...
                                <img src={stories.image} alt={stories.title} loading="lazy" className="w-full h-full object-fill rounded-md" />
                            ...
                            <div className="flex-1">
                                <h2 className="text-gray-800 text-lg font-medium leading-6 mb-2">{stories.title}</h2>
                                ...
                                <p className="text-gray-600 text-[13px] leading-5 max-w-4xl mb-3 line-clamp-5" title={stories.description}>
                                {stories.description}
                                </p>
